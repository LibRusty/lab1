...
int main(int argc, char *argv[])
{
    ...
    std::vector<FileT*> files{new FileT(&a, "C:/lab1/1.txt"), new FileT(&a, "C:/lab1/2.txt"), new FileT(&a, "C:/lab1/3.txt"), new FileT(&a, "C:/lab1/4.txt"), new FileT(&a, "C:/lab1/5.txt"), new FileT(&a, "C:/lab1/6.txt")};
